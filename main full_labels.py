...
def split_to_coco_creator(input_instance_array, labels):
    ...
    label_image_info[label_image_info < 30]=0
    label_image_info[(label_image_info > 34)&(label_image_info < 105)]=0
    label_image_info[(label_image_info > 115)]=0
    d = {30:1, 32:2, 33:3, 34:4, 105:5, 106:6, 107:7, 108:8, 109:9, 110:10, 111:11, 112:12, 113:13, 114:14}
    # Replacing values
    for i,j in d.items():
    ...
    for label_id, label in enumerate(labels):
        ...
        if (label_id in (unique_label_info)) and (label["instances"] == True):
            print("label {}: {}".format(label_id, label))
